...
$artworkIdsResult = $conn->query("SELECT DISTINCT artwork_id FROM art_reviews ORDER BY id DESC LIMIT 5");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_FILES["fileToUpload"]["name"])) {
    ...
    header("Location: reviews.php?upload=1");
    exit(); 
}
    ...
    <div class="results-container">
        <?php 
            ...
            while ($imageRow = $imageResult->fetch_assoc()) {
                ...
                echo "<img src='$imagePath' alt='Artwork'>";
                echo "<h2>Artwork ID: $artworkId</h2>";
